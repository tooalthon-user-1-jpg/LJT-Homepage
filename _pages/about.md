...
First-year PhD candidate at the [HKUST NLP Group](https://github.com/HKUNLP), advised by [Professor Junxian He](https://hejunxian.github.io/).
...
2. **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. "On the Perception Bottleneck of VLMs for Chart Understanding." arXiv, 2025. [Code: Vision4Chart](https://github.com/Vicent0205)

3. **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. "On the Universal Truthfulness Hyperplane Inside LLMs." EMNLP 2024. [Code: Universal_Truthfulness_Hyperplane](https://github.com/Vicent0205)
...
Natural Language Processing, Machine Learning, Large Language Models (LLMs), Reasoning and Reinforcement Learning, Vision-Language Models (VLMs), Hallucination Mitigation, LLM Truthfulness and Interpretability, Verifiable Reasoning Data Synthesis.
